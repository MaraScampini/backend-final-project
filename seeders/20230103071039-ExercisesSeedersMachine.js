    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          material: "Machine",
          description:
            "Before you step onto the treadmill, ensure that the belt is stationary and the safety clip is attached to the treadmill (if one exists). When you step on the treadmill, place your feet on the frame to the sides of the belt whilst holding the handrail. Turn on the treadmill using either a quick start button or selecting a program. Ensure the speed is one you can comfortably maintain when you step on the belt. If you're unsure, begin with a walking pace. Start and finish each workout with a minimum five minute warm up and cool down. Once you get moving and feel stable, remove your hands from the rails and increase the speed to your desired pace. To come to a stop, place your hands on the handrails and feet on the frame to the sides of the belt. Hit the stop button and allow the belt to come to a complete stop.",
          image_path: "67.gif",
          createdAt: "2023-01-03 00:00:00",
          updatedAt: "2023-01-03 00:00:00",
        },
